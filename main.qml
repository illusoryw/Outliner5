...
//        }
    ...
    RowLayout {
        ...
        ToolButton {
           text:"字体颜色"
           onClicked: if(fileOpened){colorDialog.open();}
        }
...
menuBar: MenuBar {
    ...
    Menu {
        ...
        MenuItem {
            text: qsTr("查找")
            shortcut: "Ctrl+F"
            onTriggered:if(fileOpened){findtextdlg.visible = true;}
        }
        MenuItem {
            text: qsTr("查找下一个")
        ...
        MenuItem {
            text: qsTr("日期/时间")
            onTriggered: if(fileOpened){textareaid.insert(textareaid.cursorPosition,Qt.formatDateTime(new Date(), "dddd yyyy-MM-dd MMM hh-mm-ss"))}
            //shortcut: "Ctrl+X"
        }
    ...
    Menu {
        ...
        MenuItem {
            ...
            shortcut: "Ctrl+Z"
            checkable: true;
            onTriggered:  if(fileOpened){setStatusBarState();}
        ...
        MenuItem {
            text: qsTr("字体")
            shortcut: "Ctrl+C"
             onTriggered: if(fileOpened){fontDialog.open();}
